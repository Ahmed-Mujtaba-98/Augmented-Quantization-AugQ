...
if __name__ == '__main__':
    ...
    # build quantization parameters: This setting is for initiating AugQ granularity
    wq_params = {'n_bits': args.n_bits_w, 'channel_wise': False, 'scale_method': 'mse'}
    ...
    # Calibrate quantized network on 64 training samples
    with torch.no_grad():
